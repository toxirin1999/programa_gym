    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('hito', 'Hito'), ('consistencia', 'Consistencia'), ('superacion', 'Superación'), ('especial', 'Especial'), ('exploracion', 'Exploración'), ('equilibrio', 'Equilibrio'), ('social', 'Social'), ('tecnica', 'Técnica'), ('recuperacion', 'Recuperación')], default='hito', max_length=20, verbose_name='Categoría')),
                ('descripcion', models.TextField(blank=True, verbose_name='Descripción')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=50, verbose_name='Nombre')),
                ('periodo', models.CharField(choices=[('diaria', 'Diaria'), ('semanal', 'Semanal'), ('mensual', 'Mensual'), ('progresiva', 'Progresiva'), ('permanente', 'Permanente'), ('especial', 'Especial')], default='semanal', max_length=20, verbose_name='Periodo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('orden_secuencia', models.IntegerField(blank=True, help_text='Para misiones progresivas, indica el orden en la secuencia', null=True, verbose_name='Orden en secuencia')),
                ('grupo_secuencia', models.CharField(blank=True, help_text='Identificador del grupo de misiones progresivas', max_length=50, null=True, verbose_name='Grupo de secuencia')),
                ('requisito_anterior', models.CharField(blank=True, help_text='Nombre de la misión que debe completarse antes', max_length=100, null=True, verbose_name='Requisito anterior')),
                ('fecha_inicio_evento', models.DateField(blank=True, help_text='Para misiones especiales con tiempo limitado', null=True, verbose_name='Fecha inicio evento')),
                ('fecha_fin_evento', models.DateField(blank=True, help_text='Para misiones especiales con tiempo limitado', null=True, verbose_name='Fecha fin evento')),
