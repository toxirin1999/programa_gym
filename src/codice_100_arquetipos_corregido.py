# Script para crear el Códice de las Leyendas completo con 100 Arquetipos
# Ejecutar con: python manage.py shell < codice_100_arquetipos_corregido.py
...
# Crear algunas pruebas legendarias de ejemplo para los primeros niveles
print("\n⚔️ Creando pruebas legendarias de ejemplo...")

# Pruebas para Saitama (inicio) - Nivel 1
saitama = Arquetipo.objects.get(nivel=1)
pruebas_saitama = [
    {
        'nombre': 'El Entrenamiento de Saitama',
        'descripcion': 'Completa tu primer entrenamiento. Todo héroe comienza con un solo paso.',
    ...
    },
    {
        ...
        'descripcion': 'Entrena 3 días consecutivos. La constancia es la clave del poder.',
...
for prueba_data in pruebas_saitama:
    prueba = PruebaLegendaria.objects.create(arquetipo=saitama, **prueba_data)
    print(f"⚔️ Creada: {prueba}")

# Pruebas para Rock Lee - Nivel 2
lee = Arquetipo.objects.get(nivel=2)
pruebas_lee = [
    {
        'nombre': 'Las Puertas del Esfuerzo',
        'descripcion': 'Mantén una racha de 7 días entrenando. El trabajo duro supera al talento.',
        'clave_calculo': 'racha_7_dias',
        'meta_valor': 7,
    ...
    },
    {
        ...
        'descripcion': 'Completa 10 entrenamientos. Tu pasión juvenil no conoce límites.',
...
print(f"\n✨ Pruebas Legendarias creadas: {PruebaLegendaria.objects.count()}")
print("🎯 Puedes añadir más pruebas específicas para cada arquetipo según necesites")
